(ns sixsq.nuvla.ui.common-components.deployment-dialog.views-summary
  (:require [clojure.string :as str]
            ...
            [sixsq.nuvla.ui.common-components.deployment-dialog.views-data :as data-step]
            [sixsq.nuvla.ui.common-components.deployment-dialog.views-env-variables :as env-variables-step]
            [sixsq.nuvla.ui.common-components.deployment-dialog.views-files :as files-step]
            [sixsq.nuvla.ui.common-components.deployment-dialog.views-infra-services :as infra-services-step]
            [sixsq.nuvla.ui.common-components.deployment-dialog.views-license :as license-step]
            [sixsq.nuvla.ui.common-components.deployment-dialog.views-module-version :as module-version-step]
            [sixsq.nuvla.ui.common-components.deployment-dialog.views-price :as price-step]
            [sixsq.nuvla.ui.common-components.deployment-dialog.views-registries :as registries-step]
