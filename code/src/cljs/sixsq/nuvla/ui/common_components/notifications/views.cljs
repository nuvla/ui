(ns sixsq.nuvla.ui.common-components.notifications.views
  (:require [cljs.spec.alpha :as s]
            [clojure.string :as str]
            [re-frame.core :refer [dispatch dispatch-sync subscribe]]
            [re-frame.db]
            [reagent.core :as r]
            [sixsq.nuvla.ui.common-components.filter-comp.events :as fc-events]
            [sixsq.nuvla.ui.common-components.i18n.subs :as i18n-subs]
            [sixsq.nuvla.ui.common-components.notifications.events :as events]
            [sixsq.nuvla.ui.common-components.notifications.spec :as spec]
            [sixsq.nuvla.ui.common-components.notifications.subs :as subs]
