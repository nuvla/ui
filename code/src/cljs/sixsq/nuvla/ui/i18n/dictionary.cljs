...
(def dictionary
  {:en {:lang                                      "english"
   ...
   :fr {:lang                            "français"
        ...
        :create-user-inst                "Entrez l'adresse e-mail de la personne que vous souhaitez inviter a utiliser Nuvla. Une invitation sera envoyé a cette personne. Vous pouvez à partir de maintenant partager avec cette personne vos ressources via les ACL."
        :created                         "créé"
