...
(def dictionary
  {:en {:lang                                      "English"
        ...
        :create                                    "create"
        :create-an                                 "Create an "
        :create-nuvlabox-usb                       "USB automated installation"
        :create-nuvlabox-usb-help                  "Hands-free installation"
        :create-nuvlabox-usb-popup                 "By clicking here, a new API key credential will be generated for you,\n                              and included in a trigger file that you must place inside a USB stick"
        :created                                   "created"
        ...
        :download                                  "download"
        :download-nuvlabox-trigger                 "Download your NuvlaBox installation trigger"
        :drop-file                                 "drop file"
        :edge                                      "NuvlaBox"
   ...
   :fr {:lang                                      "Français"
        ...
        :count                                     "décompte"
        :create                                    "créer"
        :create-nuvlabox-usb                       "installation par USB"
        :create-nuvlabox-usb-help                  "installation mains-libres"
        :create-nuvlabox-usb-popup                 "En cliquant ici, une nouvelle clé API sera généré pour vous, et inclus dans un fichier que vous devez placer dans une clé USB"
        :create-an                                 "Créer un "
        :created                                   "créé"
        ...
        :download-nuvlabox-trigger                 "Télécharger le fichier d'installation pour la NuvlaBox"
