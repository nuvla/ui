...
(def dictionary
  {:en {:lang                                      "english"
        ...
        :manage                                    "manage"
        :message                                   "message"
        :message-no-credetnial                     "You don't have any credential for your Swarm!"
        ...
        :module-no-env-variables                   "Pas de variables d'environement defini pour cette application"
   ...
   :fr {:lang                            "français"
        ...
        :manage                          "gérer"
        :message                         "message"
        :message-no-credetnial           "Vous n'avez pas encore une information d'identification pour votre Swarm!"
        ...
        :module-env-variables-help       "Définition  des variables d'environement du container avec quelques champs en extra comme la description et requis."
