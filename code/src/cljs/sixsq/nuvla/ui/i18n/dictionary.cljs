...
(def dictionary
  {:en {:lang                                      "english"
        ...
        :create-user-inst                          "Enter the email address of the person you want to invite to use Nuvla. An invitation will be send to him. You can from now share resources with this new user via resource's ACLs."
        :created                                   "created"
   ...
   :fr {:lang                            "français"
        ...
        :create-user-inst                "Entrez l'adresse e-mail de la personne que vous souhaitez inviter à utiliser Nuvla. Une invitation sera envoyé à cette personne. Vous pouvez à partir de maintenant partager avec cette personne vos ressources via les ACL."
        :created                         "créé"
