...
(def dictionary
  {:en {:lang                                      "English"
        ...
        :deployment-delete-warning                 "I understand that deleting this deployment is permanent and cannot be undone."
        :describe                                  "describe"
   ...
   :fr {:lang                            "Français"
        ...
        :deployment-delete-warning       "Je comprends que la suppression de ce déploiement est permanente et ne peut pas être annulée."
        :describe                        "décrire"
        :description                     "description"
        :details                         "détails"
        :documentation                   "documentation"
