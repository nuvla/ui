...
(def dictionary
  {:en {:lang                            "english"
        ...
        :module-docker-image-placeholder "e.g. ubuntu:18.11"
        ...
        :module-port-mapping             "Port Mappings"
        :module-port-mapping-help        "Definitions of port mappings between the container and its host - e.g. \"tcp:22:22\", \"tcp::80\", \"tcp:8022-8023:2222-2223\""
        ...
        :module-volume-read-only?        "Read only?"
        :module-volume-help              "Volumes (or mounts) definitions for the container. You can define custom type and driver"
        :module-volume-section-desc      "Container volumes (i.e. mounts) "
        :modules                         "modules"
        :more                            "more"
   ...
   :fr {:lang                            "français"
        ...
        :module-port-mapping             "Redirection de ports"
        :module-port-mapping-help        "Definitions de la redirection de ports entre le container et son hôte - p.ex.: \"tcp:22:22\", \"tcp::80\", \"tcp:8022-8023:2222-2223\""
        ...
        :module-volume-read-only?        "Lecture seule?"
        :module-volume-help              "Définitions des volumes (ou 'mounts') du container. Vous pouvez définir le type et le pilot ('driver')"
        :module-volume-section-desc      "Volume pour les containers (i.e. `mounts`) "
        :modules                         "modules"
        :more                            "plus"
