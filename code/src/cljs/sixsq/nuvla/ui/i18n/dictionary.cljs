...
(def dictionary
  {:en {:lang                                      "English"
   ...
   :fr {:lang                            "Français"
        ...
        :credentials-add-message         "Choisissez le type d'identification que vous voulez ajouter."
        ...
        :module-docker-compose-help      "Par défaut, les variables d'environements de l'application ne sont pas envoyées aux services définis dans votre stack. Afin d'autoriser Nuvla à passer une variable d'environement référencez là - p.ex. : MY-ENV-VAR=$MY-ENV-VAR"
