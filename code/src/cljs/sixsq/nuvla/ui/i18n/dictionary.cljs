...
(def dictionary
  {:en {:lang                                      "English"
        ...
        :create                                    "create"
        :create-an                                 "Create an "
        :create-nuvlabox-compose                   "Get your NuvlaBox as a bundle of compose files, and install it with a single Docker Compose command"
        :create-nuvlabox-usb                       "Automate the installation of multiple NuvlaBox devces with a single USB stick. With this method, a new API key credential will be generated for you, and included in a trigger file that you must place inside a USB stick"
        :created                                   "created"
