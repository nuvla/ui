(ns sixsq.nuvla.ui.pages.apps.apps-component.utils
  (:require [sixsq.nuvla.ui.pages.apps.apps-component.spec :as spec]
...
(defn ports->module
  ...
  (into
    []
    (for [[_id p] (get-in db [::spec/module-component ::spec/ports])]
...
(defn mounts->module
  ...
  (into
    []
    (for [[_id m] (get-in db [::spec/module-component ::spec/mounts])]
