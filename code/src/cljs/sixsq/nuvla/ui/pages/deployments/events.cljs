(ns sixsq.nuvla.ui.pages.deployments.events
  (:require [cljs.spec.alpha :as s]
            ...
            [sixsq.nuvla.ui.common-components.plugins.table :as table-plugin :refer [ordering->order-string]]
  ...
  (fn [{db :db} [_ filter-str module-href]]
    (cond-> {:db (assoc db ::spec/bulk-update-modal {:filter-str  filter-str
            ...
            module-href (assoc
                          ...
                          [module-href
                           #(dispatch
                              [:sixsq.nuvla.ui.pages.deployments-detail.events/set-module-versions %])]))))
