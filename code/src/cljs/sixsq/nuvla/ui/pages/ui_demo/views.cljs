(ns sixsq.nuvla.ui.pages.ui-demo.views
...
(comment
  ...
  (dispatch [::remove-col :state :sixsq.nuvla.ui.pages.edges.views/table-cols-config])
  (dispatch [::remove-col :created :sixsq.nuvla.ui.pages.edges.views/table-cols-config])
  ...
  (dispatch [::reset-current-cols :sixsq.nuvla.ui.pages.edges.views/table-cols-config]))