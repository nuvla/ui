(ns sixsq.nuvla.ui.utils.defines
...
(goog-define
  ^{:documentation
    ...
    {:compiler-options
      {:closure-defines
        {'sixsq.nuvla.ui.utils.defines/LOGGING_LEVEL \"info\"}}
    "}
  LOGGING_LEVEL "info")
...
(goog-define
  ^{:documentation
    "determine the host url
     ...
     {:compiler-options
       {:closure-defines
         {'sixsq.nuvla.ui.utils.defines/HOST_URL \"https://nuv.la\"}}
...
(goog-define
  ^{:documentation
    "determine the web application prefix
     ...
     The default is to concatenate '/ui' to the end of the NUVLA_URL.
     If the application is mounted elsewhere, you can change the default with:

     {:compiler-options
       {:closure-defines
         {'sixsq.nuvla.ui.utils.defines/CONTEXT \"\"}}
     "}
  CONTEXT "/ui")
