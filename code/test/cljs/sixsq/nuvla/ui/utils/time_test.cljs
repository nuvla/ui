...
(deftest ago-test
  (doseq [test-case time-ago-test-cases]
    (let [past-moment (time/subtract-milliseconds this-moment (key test-case))]
      (is (=  (:en (val test-case)) (time/ago past-moment)))
      (is (= (:en (val test-case)) (time/ago past-moment "en")))
      (is (= (:fr (val test-case)) (time/ago past-moment "fr"))))))
...
(deftest remaining-test
  (doseq [test-case time-to-go-test-cases]
    (let [past-moment (time/add-milliseconds this-moment (key test-case))]
