...
const resourceLogFetchResponses = [
  {
    status: 202,
    statusText: '',
    httpVersion: 'HTTP/2.0',
    ...
    headers: [
      { name: 'alt-svc', value: 'h3=":443"; ma=2592000' },
      { name: 'content-length', value: '278' },
      { name: 'content-type', value: 'application/json' },
      { name: 'date', value: 'Thu, 23 Feb 2023 11:59:03 GMT' },
      { name: 'location', value: 'job/33cd13c5-4928-45da-98c0-86e2c79ab009' },
      { name: 'server', value: 'Caddy' },
      { name: 'server', value: 'Aleph/0.4.4' },
    ],
    content: {
      size: -1,
      mimeType: 'application/json',
      text: '{\n  "status" : 202,\n  "message" : "starting resource-log/756d6e6b-fc1e-48c2-a0fc-c47537201743 with async job/33cd13c5-4928-45da-98c0-86e2c79ab009",\n  "resource-id" : "resource-log/756d6e6b-fc1e-48c2-a0fc-c47537201743",\n  "location" : "job/33cd13c5-4928-45da-98c0-86e2c79ab009"\n}',
    },
    headersSize: -1,
    bodySize: -1,
    redirectURL: '',
  },
  {
    ...
    headers: [
      ...
      { name: 'content-type', value: 'application/json' },
      { name: 'date', value: 'Thu, 23 Feb 2023 11:59:08 GMT' },
      { name: 'location', value: 'job/9a73c113-ec50-4300-8b14-6b952ceb007b' },
      { name: 'server', value: 'Caddy' },
      { name: 'server', value: 'Aleph/0.4.4' },
    ],
    content: {
      size: -1,
      mimeType: 'application/json',
      text: '{\n  "status" : 202,\n  "message" : "starting resource-log/756d6e6b-fc1e-48c2-a0fc-c47537201743 with async job/9a73c113-ec50-4300-8b14-6b952ceb007b",\n  "resource-id" : "resource-log/756d6e6b-fc1e-48c2-a0fc-c47537201743",\n  "location" : "job/9a73c113-ec50-4300-8b14-6b952ceb007b"\n}',
    },
    headersSize: -1,
    bodySize: -1,
    redirectURL: '',
  },
  {
    ...
    headers: [
      ...
      { name: 'content-type', value: 'application/json' },
      { name: 'date', value: 'Thu, 23 Feb 2023 11:59:18 GMT' },
      { name: 'location', value: 'job/c6bab054-f92a-4747-b6fe-07681e6c1fd0' },
      { name: 'server', value: 'Caddy' },
      { name: 'server', value: 'Aleph/0.4.4' },
    ],
    content: {
