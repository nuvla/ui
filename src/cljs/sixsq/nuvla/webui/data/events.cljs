(ns sixsq.nuvla.webui.data.events
  (:require
    [clojure.string :as str]
    [re-frame.core :refer [dispatch reg-event-db reg-event-fx]]
    [sixsq.nuvla.webui.cimi-api.effects :as cimi-api-fx]
    [sixsq.nuvla.webui.client.spec :as client-spec]
    [sixsq.nuvla.webui.data.effects :as fx]
    [sixsq.nuvla.webui.data.spec :as spec]
    [sixsq.nuvla.webui.data.utils :as utils]
    [sixsq.nuvla.webui.deployment-dialog.events :as dialog-events]
    [sixsq.nuvla.webui.deployment-dialog.spec :as dialog-spec]))
