(ns sixsq.nuvla.webui.deployment-dialog.events
  (:require
    [clojure.string :as str]
    [re-frame.core :refer [dispatch reg-event-db reg-event-fx]]
    [sixsq.nuvla.webui.cimi-api.effects :as cimi-api-fx]
    [sixsq.nuvla.webui.client.spec :as client-spec]
    [sixsq.nuvla.webui.data.spec :as data-spec]
    [sixsq.nuvla.webui.data.utils :as data-utils]
    [sixsq.nuvla.webui.deployment-dialog.spec :as spec]
    [sixsq.nuvla.webui.deployment-dialog.utils :as utils]
    [sixsq.nuvla.webui.history.events :as history-evts]
