(ns sixsq.nuvla.webui.legacy-application.effects
  (:require-macros
  ...
  (:require
    ...
    [sixsq.nuvla.client.api.modules :as modules]))
    ...
    (go
      (let [module (if (nil? module-id) {} (<! (modules/get-module client module-id)))
            ...
            module-data {:metadata   metadata
                         ...
                         :children   children}]
        (dispatch [:sixsq.nuvla.webui.legacy-application.events/set-module module-id module-data])))))
