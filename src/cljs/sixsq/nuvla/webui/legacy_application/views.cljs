(ns sixsq.nuvla.webui.legacy-application.views
  (:require
    [re-frame.core :refer [dispatch subscribe]]
    [reagent.core :as reagent]
    [sixsq.nuvla.webui.i18n.subs :as i18n-subs]
    [sixsq.nuvla.webui.legacy-application.events :as application-events]
    [sixsq.nuvla.webui.legacy-application.subs :as application-subs]
