(ns sixsq.nuvla.webui.nuvlabox.views
  (:require
    ...
    [sixsq.nuvla.webui.nuvlabox-detail.events :as nuvlabox-detail-events]
    [sixsq.nuvla.webui.nuvlabox-detail.views :as nuvlabox-detail]
    [sixsq.nuvla.webui.nuvlabox.events :as nuvlabox-events]
    [sixsq.nuvla.webui.nuvlabox.subs :as nuvlabox-subs]
