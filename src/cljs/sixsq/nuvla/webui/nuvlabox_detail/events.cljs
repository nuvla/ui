(ns sixsq.nuvla.webui.nuvlabox-detail.events
  (:require
    [re-frame.core :refer [dispatch reg-event-db reg-event-fx]]
    [sixsq.nuvla.webui.client.spec :as client-spec]
    [sixsq.nuvla.webui.nuvlabox-detail.effects :as nuvlabox-fx]
    [sixsq.nuvla.webui.nuvlabox-detail.spec :as nuvlabox-spec]))
