(ns sixsq.nuvla.webui.nuvlabox-detail.views
  (:require
    ...
    [sixsq.nuvla.webui.nuvlabox-detail.events :as nuvlabox-events]
    [sixsq.nuvla.webui.nuvlabox-detail.subs :as nuvlabox-subs]
    [sixsq.nuvla.webui.nuvlabox.utils :as u]
    [sixsq.nuvla.webui.plot.plot :as plot]
