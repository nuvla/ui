(ns sixsq.nuvla.webui.utils.defines
...
(goog-define
  ^{:documentation
    ...
    {:compiler-options
      {:closure-defines
        {'sixsq.nuvla.webui.webui.defines/LOGGING_LEVEL \"info\"}}
    "}
  LOGGING_LEVEL "info")
...
(goog-define
  ^{:documentation
    "determine the host url
     ...
     {:compiler-options
       {:closure-defines
         {'sixsq.nuvla.webui.webui.defines/HOST_URL \"https://nuv.la\"}}
...
(goog-define
  ^{:documentation
    "determine the web application prefix
     ...
     {:compiler-options
       {:closure-defines
         {'sixsq.nuvla.webui.webui.defines/CONTEXT \"\"}}
     "}
  CONTEXT "/webui")
