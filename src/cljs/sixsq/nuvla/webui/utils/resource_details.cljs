(ns sixsq.nuvla.webui.utils.resource-details
  (:require
    [cljs.pprint :refer [pprint]]
    [re-frame.core :refer [dispatch subscribe]]
    [reagent.core :as r]
    [sixsq.nuvla.webui.cimi-api.utils :as cimi-api-utils]
    [sixsq.nuvla.webui.cimi-detail.events :as api-detail-events]
    ...
    [sixsq.nuvla.webui.utils.table :as table]
    [sixsq.nuvla.webui.utils.time :as time]
    [sixsq.nuvla.webui.utils.values :as values]))
